...
CREATE TABLE "new_OrderItem" (
    ...
    "fileDensity" DECIMAL NOT NULL DEFAULT 1,
...
INSERT INTO "new_OrderItem" ("categoryId", "height", "id", "note", "orderId", "qty", "subtotal", "unitPrice", "variantId", "width") SELECT "categoryId", "height", "id", "note", "orderId", "qty", "subtotal", "unitPrice", "variantId", "width" FROM "OrderItem";
