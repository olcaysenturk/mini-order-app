  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      try {
        ...
        url.searchParams.set('active', '1')      // sadece aktifleri iste
      ...
      <div className="p-6">
        <div className="mx-auto max-w-2xl rounded-2xl border bg-white p-6 shadow-sm">
          <div className="flex items-start gap-3">
            <div className="rounded-xl bg-amber-100 px-3 py-1.5 text-sm font-medium text-amber-800">Bilgi</div>
            <div>
  ...
  return (
    <div className="p-6">
      <div className="mx-auto max-w-3xl">
        ...
        <form onSubmit={onSubmit} className="space-y-6 rounded-2xl border bg-white p-5 shadow-sm">
          {/* ŞUBE/BAYİ */}
          <section>
          ...
          <section className="rounded-2xl border p-4">
            ...
            <div className="mb-4 inline-flex rounded-xl border p-1">
              <button
                ...
                className={`inline-flex items-center gap-2 rounded-lg px-3 py-1.5 text-sm ${mode === 'pick' ? 'bg-gray-900 text-white' : ''}`}
              >
              ...
              <button
                ...
                className={`inline-flex items-center gap-2 rounded-lg px-3 py-1.5 text-sm ${mode === 'create' ? 'bg-gray-900 text-white' : ''}`}
              >
          ...
          <div className="flex gap-3">
            ...
            <a href="/orders" className="rounded-xl border px-4 py-2">Vazgeç</a>
          </div>
        </form>
      </div>
